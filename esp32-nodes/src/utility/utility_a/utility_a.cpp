// utility_a.cpp
// Chain: utility_a → mv_switchgear_a → mv_lv_transformer_a / generator_a → ats_a → lv_dist_a → ups_a → pdu_a → rectifier_a → server_rack
// Node: utility_a — Root node. 230 kV 3-phase grid source, Side A.
