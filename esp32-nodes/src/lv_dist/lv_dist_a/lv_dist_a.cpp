// lv_dist_a.cpp
// Chain: ats_a → [lv_dist_a] → ups_a, cooling_a, lighting_a, monitoring_a
// Node: lv_dist_a — 480 V LV distribution board, 384 kW rated, Side A.
...
void updateDisplay() {
  ...
  // Line 1: node label + state (lv_dist_a fits within 21 chars)
  display.print("lv_dist_a [");
