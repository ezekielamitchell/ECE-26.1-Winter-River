// mv_switchgear_a.cpp
// Chain: utility_a → [mv_switchgear_a] → mv_lv_transformer_a
// Node: mv_switchgear_a — 34.5 kV medium-voltage switchgear, Side A.
...
// ─── Node identity ───────────────────────────────────────────────────────────
const char *node_id = "mv_switchgear_a";
...
void setup() {
  ...
  display.clearDisplay();
  display.setCursor(0, 0);
  display.println("mv_switchgear_a");
