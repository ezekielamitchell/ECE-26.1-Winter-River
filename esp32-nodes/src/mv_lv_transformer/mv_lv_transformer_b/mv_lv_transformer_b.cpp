// mv_lv_transformer_b.cpp
// Chain: mv_switchgear_b → [mv_lv_transformer_b] → ats_b
// Node: mv_lv_transformer_b — 34.5 kV→480 V step-down transformer, 1000 kVA, Side B.
...
// ─── Node identity ───────────────────────────────────────────────────────────
const char *node_id = "mv_lv_transformer_b";
...
void setup() {
  ...
  display.clearDisplay();
  display.setCursor(0, 0);
  display.println("mv_lv_transformer_b");
