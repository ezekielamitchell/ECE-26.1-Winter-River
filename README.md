...
| Component Types        | 26 modules (13 Side A + 13 Side B)            | Utility, HV/MV transformer, MV switchgear, MV/LV transformer, LV switchgear, generator, ATS, UPS, cooling, 4× server_rack per side. BMS aggregator is broker-synthesized (no ESP32 board required). |
